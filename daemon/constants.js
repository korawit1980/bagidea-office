...
const SKILL_LIBRARY = {
  ...
  "office-ops": {
    ...
    content: [
      ...
      "- On slow days, gather the team and turn ideas into things worth building. Don't only think small:",
      "  a quick office plugin is great, but also think bigger — a real website, a web app, a serious",
      "  program or tool — as a standalone project in the workspace. Match the ambition to the idea.",
